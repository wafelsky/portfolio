...
function App() {
  return (
    ...
    <Skeleton 
    adjectives={adjectives} skills={skills} 
    about={about} viewer={viewer}  
    logos={logos} navicons={navicons}
    />
    </div>
  );
}
...
const navicons = [
  ...
  ["fas fa-at","link","https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=mazurjakubb@gmail.com"],
  ["fab fa-linkedin","link","https://www.linkedin.com/in/jakub-mazur-99a312195/"],
 
  
]

const about = [["Main Skills",["- Quick learner.","- Creative.","- Hard worker.", "- Continuously improving."]], 
["Certificates",["- mainfiles Algorithms and Data Structures","- Responsive Web Design","- Front End Libraries"]], 
["Education",["- AGH-environmental engineering-engineering diploma"]],
["Soft-Skills",["- English - C1","- Drivers Licence - B1"]],  
]

const  skills =[["React",98,"fab fa-react"],["HTML",84,"fab fa-html5"],["JS",84,"fab fa-node-js"],["Bootstrap",42,"fab fa-bootstrap"],
["JQuery",42],["SASS",84,"fab fa-sass"],["Redux",42],["CSS",98],["CSS-3D",70],["Canvas",56]]

const logos=[[sass],[bootstrap],[css],[git],[html],[redux],[react],[npm]]


const viewer = [   //Z / X cords      name      picture     href on click 
