...
class FirstSection extends React.Component {
  ...
  componentDidMount() {
    setInterval(() => {
      this.state.incrementmesege < this.props.adjectives.length - 1
        ? this.setState({ incrementmesege: this.state.incrementmesege + 1 })
        : this.setState({ incrementmesege: 0 });
      this.setState({
        animname: this.state.animname === "fadesign" ? "fadesign2" : "fadesign",
      });
    }, 3000);
  }
        ...
        <div className="center overflow-img">
          <div className="first-section-wrapper">
            <div className="first-section-img-wrapper">
              <img className="first-section-img" src={blackbackground}></img>
            </div>
            <div className="first-mesege-class">
              <h1 className="welcome-messge-font ">
                Hello,I'm <b>Mazur Jakub</b>{" "}
              </h1>
              <h3
                className="awesomeanim"
                style={{ animationName: this.state.animname }}
              >
                <b>{this.props.adjectives[this.state.incrementmesege]} </b>
              </h3>
        ...
        <div className="about-centered">
          <div className="flex-fluid about-addon">
            <div className="cute-wrapper">
              <img src={cute} className="cute-img"></img>
            </div>
            <div className="about-section-right">
              <h1
                className="big-header "
                style={{ textAlign: "left", marginLeft: "" }}
              >
                About me
              </h1>
              <p>
                I am a graduate in the field of Environmental Engineering at AGH
                University of Science and Technology in Kraków - Poland. During
                my time at the university, I have been self-studying coding. I
                am very motivated and open-minded currently looking for a
                remote/stationary junior React Developer position.
              </p>
              <div className="button-about-me-pannel">
                ...
                {this.props.about.map((x, i) => {
                  return (
                    <div
                      key={i}
                      className="about-b-wrapper"
                      onClick={() => {
                        this.setState({
                          currentmessege: this.props.about[i][0],
                        });
                      }}
                    >
                      <div className="ab-center">
                        <div className="center-ab-row">
                          <div className="text-ab-wrapper">
                            <h1
                              className="buttonOh1 ab-text"
                              style={{
                                color:
                                  this.state.currentmessege ===
                                  this.props.about[i][0]
                                    ? styles.cfour
                                    : "black",
                              }}
                            >
                          ...
                          {/* STRECHER */}
                          <h1 className="buttonOh1" style={{ opacity: 0 }}>
                            {this.props.about[i][0]}
                          </h1>
                          {/* STRECHER */}
                        </div>
                      ...
                      <div
                        ...
                        style={{
                          width:
                            this.state.currentmessege === this.props.about[i][0]
                              ? "200px"
                              : "0px",
                        }}
                      ></div>
                    ...
                    >
                      {
                        <div>
                          {" "}
                          {this.props.about[i][1].map((m, l) => {
                            return (
                              <p className="about-me-paragraphs" key={m}>
                                {this.props.about[i][1][l]}
                              </p>
                            );
                          })}{" "}
                        </div>
            ...
            <div className="box-row-wrapper">
              {this.props.skills.map((x, i) => {
                return (
                  <div key={i}>
                    {" "}
                    <Skillbars i={i} skills={this.props.skills} />
                  </div>
                );
              })}
            </div>
...
class Skillbars extends React.Component {
    ...
    if (this.stopinterval === false) {
      let increment = () => {
        if (this.max > this.state.percent && this.over) {
          ...
          this.setState({
            barheight: this.state.barheight + 1.4,
  ...
  componentDidMount() {
    ...
    document.addEventListener("scroll", () => {
      if (this.state.width < 619) {
        ...
        let local = document
          .getElementById(this.props.skills[this.props.i][0])
  ...
  render() {
    return (
      <div
        id={this.props.skills[this.props.i][0]}
      ...
      >
        <h1
          className="skill-box-header"
          style={{ color: this.state.scrollhover }}
        >
          {this.props.skills[this.props.i][0]}
          <i className={this.props.skills[this.props.i][2]}></i>
        </h1>
        <div className="skill-elements">
          <div
            className="colorfull-skillbar"
            style={{ height: this.state.barheight }}
          ></div>
          <div
            className="percent-indicators i-1 " /* style={{marginTop:60+(140-this.props.skills[i][1])+"px"}}*/
          >
            <h2
          ...
          <div className="percent-indicators i-2">
            <h2
              className="indicator-text"
              style={{ color: this.state.scrollhover }}
            >
...
class Viewer extends React.Component {
  ...
  form() {
    if (this.state.clicked === false) {
      ...
      this.state.formmargin === "-400px"
        ? this.setState({ formmargin: "6px" })
        : this.setState({ formmargin: "-400px" });
      this.state.overflowindex === -1
  ...
  render() {
    let moving = {
      transform: `translateZ(${this.state.translateZ}px)translateX(${this.state.translateX}px)`,
    };
      ...
      <div className="section-about-wrapper secondcolor">
        ...
        <div className="about-centered">
          ...
          <div className="projects-showcase">
            ...
            */}
              <div className="button-pannel">
                <div className="button-1" onClick={this.lastproject}>
                  <i className="fas fa-arrow-circle-left arrowleft tran-05s"></i>
                </div>
                <div className="button-1" onClick={this.nextproject}>
                  <i className="fas fa-arrow-circle-left arrowright tran-05s"></i>
                </div>
              </div>
            </div>
            {/*   RENDERING  HERE */}
                ...
                <div className="wall-wrapper" style={moving}>
                  {this.state.viewer.map((x, i) => {
                    return (
                      ...
                      >
                        <Walls viewer={this.state.viewer} i={i} />
                      </div>
                    );
                  })}
                  {/*   RENDERING HERE */}
                  ...
                  {this.state.hidedetails === false && (
                    <div className="wall-floor wall-4">
                      <Baubles />{" "}
                    </div>
                  )}
                </div>
          ...
          <div
            ...
            style={{ zIndex: this.state.overflowindex }}
          >
            <form
              className="form-portfolio"
              style={{ marginTop: this.state.formmargin }}
            >
  ...
  render() {
    return (
      <div
        className="wall"
        style={{
          transform: `translateZ(${this.state.zPOZ}px)translateX(${this.state.xPOZ}px)`,
        }}
      >
        <div className="header-div">
          <h1 className="projects-header">{this.header}</h1>
        </div>
        <div className="project-prnt">
          <img src={this.img} className="project-img"></img>
        </div>
        {/* LIGHT FUUUUUUUUUUUUUUUUUUUUUUUUUUUUNC */}
        <div
          className="lights"
          style={{ opacity: this.state.opacity, zIndex: this.state.zetindex }}
          onClick={() => {
        ...
        >
          {" "}
          <i className="fas fa-question lightbulb"></i>
        </div>
              ...
              <div className="text-container-contact">
                ...
                <div className="fluid-contact">
                  <p className="contact-text">
                    Connect with me via phone: 511518517 or email:
                    mazurjakubb@gmail.com. For more information
                    <a
                      style={{ color: "cyan", cursor: "pointer" }}
                      href={cv}
                      download="MazurJakubCV"
                    >
                      {" "}
                      download
                    </a>{" "}
                  ...
                  <div className="contact-grid">
                    {this.props.logos.map((x, i) => {
                      return (
                        <div key={i} className="grid-img-cont">
                          <img
                            src={this.props.logos[i]}
                            className="con-back-img"
                          ></img>
                        </div>
                      );
                    })}
            ...
            <div className="center-flex">
              <div className="footer-iconz-wrapper">
                {this.props.navicons.map((x, i) => {
                  return (
                    <Navicons key={i} i={i} navicons={this.props.navicons} />
                  );
                })}
              </div>
            </div>
